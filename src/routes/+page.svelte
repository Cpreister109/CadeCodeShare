<script lang="ts">
	...
	// SnippetStore -> a local writable that allow us to store code snippets
	...
	<div class="grid grid-cols-1 gap-4 min-w-full md:min-w-[750px]">
		...
		<div class="card p-4 w-full text-token space-y-4">
			...
			<label class="label">
				...
				<textarea class="textarea" rows="4" placeholder="Enter snippet code here..." bind:value={formData.code}/>
			</label>
